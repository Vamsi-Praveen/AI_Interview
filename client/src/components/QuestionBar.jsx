...
const QuestionBar = ({ interviewQuestions, activeQuestion, setActiveQuestion }) => {
    ...
    return (
        <div className='transition-all flex gap-3 w-full flex-wrap'>
            ...
            <div className='flex gap-1 justify-center p-3 bg-yellow-100 rounded-md text-yellow-600'>
                <strong>Note:</strong>
                <p className='text-sm'> Please Click on the <em>Record Answer</em> when you want to answer a question.<br />Use <em className='underline underline-offset-2'>Previous</em> and <em className='underline underline-offset-2'>Next</em> Buttons to navigate between the questions.<br />After succesfull completion click on <em className='underline underline-offset-2'>End Interview</em> to stop and save the interview. </p>
            </div>
        </div>
    )
}
