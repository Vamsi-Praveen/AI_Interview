...
const InterviewCard = ({ data }) => {
    ...
    return (
        <div className='p-5 rounded-md border border-gray-200 cursor-pointer hover:bg-gray-50 hover:shadow-sm transition-all delay-75' onClick={() => { navigate(`/dashboard/interview_feedback/${data?._id}`) }}>
